...
// The Program contains 4 Class out of which 
...
// This is the second class which is using the elements of the parent class
// This class contains all the process of the program
class process extends entity{
    // Initializig the two scanner
...
// This is the Third class which is executing the overall process of the game.
class Execution extends process implements Interface1{
    public void method1(){
        Execution dublin;
        dublin = new Execution();    
...
// This is the final and the fourth class which is the public class
//  and it is the only class that contains the main method
 
public class Game extends Execution{
