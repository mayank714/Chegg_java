...
import javax.swing.SwingConstants;
 ...
 class PizzaMenu extends JFrame
{
    JCheckBox ckb[];
    JLabel jlb1;
    JRadioButton radio[], radio1[];
    static String[] pizzaToppings = "  Bell pepper, Extra cheese, Pepperoni, Sausage "
            .split(",");

    static String[] pizzaSizes = " Small: $6.50, Medium: $8.50, Large: $10".split(",");
    static String[] pizzatypes = " Thin Crust, Flatbread, Vegetarian, Sicilian Style, Neapolitan Crust, Cheese-stuffed Crust".split(",");
    ...
    private JPanel makeOptionsPanel()
    {
        ...
        JButton total = new JButton("Process order");
        ...
        jlb1 = new JLabel("                   Welcome Kitchen Pizza ");
